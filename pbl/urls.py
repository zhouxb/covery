...
urlpatterns = patterns('pbl.views.isp',
    url(r'^state$', 'index', name='isp_index'),
)
...
urlpatterns += patterns('pbl.views.survey',
    ...
    url(r'^(?P<province_id>\d+)/survey/show_json$', 'show_json', name='survey_show_json'),
...
urlpatterns += patterns('pbl.views.device_survey',
    ...
    url(r'^province/(?P<province_id>\d+)/device_survey/update_json$', 'update_json', name='device_survey_update_json'),
)

urlpatterns += patterns('pbl.views.state',
    url(r'^state/(?P<province_id>\d+)$', 'index', name='state_index'),
    url(r'^state/(?P<province_id>\d+)/device/(?P<device_id>\d+)/show$', 'show', name='state_show'),
...
urlpatterns += patterns('pbl.views.report',
    url(r'^state/(?P<province_id>\d+)/device/(?P<device_id>\d+)/report/(?P<id>\d+)$', 'show_chart', name='report_show_chart'),
